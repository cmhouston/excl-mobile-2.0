 ...
 * 			for details).</li>
 * 
 * 		<li><b> onStart, easeParams, time, defaultEase, and invalidate() are missing </b>- These properties/methods don't exist in TweenNano.</li>
 * 	</ul>
 * 
 * <hr/>	
 ...
 * 										  delay has elapsed, set immediateRender to false. </li>
 * 	
 ...
 * 	  like <code>TweenNano.killTweensOf(mc, true);</code></li>
 * 	  
