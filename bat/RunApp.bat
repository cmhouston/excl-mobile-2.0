...
::set SCREEN_SIZE= 1060x1850:1060x1850
::set SCREEN_SIZE= 1536x1848:1536x1848
::set SCREEN_SIZE= 756x1848:756x1848
::set SCREEN_SIZE= 1440x2960:1440x2960
::set SCREEN_SIZE= 1536x2048:1536x2048
